...
- The "new" button in the sidebar footer now leads with a bold accent `+` to match the tab bar's new-tab affordance; the existing tab `+` glyph is similarly emphasized.
